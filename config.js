const ownerNumber = ["556598049058@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '556598049058' 
...
const botputa = 'Não sou sua mãeKK 😡'
const botgay = 'Falou o manja rola 😡'
const botviado = 'Seu paikkk 😡'
const numbotfeio = 'comi sua irmã ontem 😡'
// KEYS
